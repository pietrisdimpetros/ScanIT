!function (e) {
    var n = new ScrollMagic.Controller,
        ...
        t = ["#slide01 header", "#slide02 header", "#slide03 header"],
        c = ["#cb01", "#cb02", "#cb03"];
    Modernizr.touch || (
        t.forEach(function (e, r) {
            {
                ...
                new ScrollMagic.Scene(
                    { triggerElement: e, offset: -95 })
                    .setClassToggle("#slide0" + t, "is-active")
                    .addTo(n)
            }
        }),
        c.forEach(function (r, t) {
            {
                var c = e(r).attr("id");
                new ScrollMagic.Scene(
                    { triggerElement: r, offset: -95 })
                    .setClassToggle("#" + c, "is-active")
                    .on("enter", function (n) {
                        e("nav")
                        .attr("class", "is-light")
                    }).addTo(n)
